...
REM
REM Generated by Vivado on Tue Nov 02 16:22:16 -0400 2021
...
echo "xvlog --incr --relax -prj IM_test_vlog.prj"
call xvlog  --incr --relax -prj IM_test_vlog.prj -log xvlog.log
